        ...
        do {
            ...
            switch (pilihan) {
                ...
                case 3 -> {
                    ...
                    Tiket ketemu = null;
                    for (int i = 0; i < daftarTiket.size(); i++) {
                        if (daftarTiket.get(i).idTiket.equals(idCari)) {
                            ketemu = daftarTiket.get(i);
                        }
                    }
 
                    if (ketemu != null) {
                        ketemu.tampilkanDetail();
                    } else {
                ...
                case 6 -> System.out.println("Terima kasih telah menggunakan sistem ini!");
